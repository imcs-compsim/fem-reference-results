...
#
# Job name:
#SBATCH --job-name=block-torsion-neo-hooke
#
# Output file:
...
CASE_PATH="$HOME/workspace/examples/fem-reference-results/examples/block_torsion_3D/nonlinear"
INPUT="$CASE_PATH/block_torsion.dat"
